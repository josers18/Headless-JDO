...
- data_360: consult the DATA CLOUD CATALOG block in the system prompt before composing any SQL; use only column names that appear verbatim in that response for the DMO you query. Never invent CRM-shaped DMO columns like AccountId__c or OwnerId__c — they are not valid just because SOQL uses AccountId / OwnerId.
